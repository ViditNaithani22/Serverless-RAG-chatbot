...
As you can see in the diagram, our architecture is divided into two parts, frontend and backend.
The front-end is pretty simple. We will store a single html file "chat-bot-ui.html" in an <b>S3</b> bucket without public access. 
Then we will create a <b>Cloud-Front</b> distribution. Mention chat-bot-ui.html as the default root object. Mention the S3 bucket as the OAC, Origin Name, and Origin Domain, this should automatically create a bucket policy for our S3 bucket that grants the cloudfront the access to the bucket.

<img width="255" height="116" alt="image" src="https://github.com/user-attachments/assets/04491784-cb0d-45dc-afb6-f5992fc13115" />
<img width="613" height="321" alt="image" src="https://github.com/user-attachments/assets/ab116162-16f6-46d7-aaad-ef2ef05cd862" />
<img width="354" height="310" alt="image" src="https://github.com/user-attachments/assets/df5c3c74-350e-43ba-8225-708f4808f76c" />
you should be able to see your website on this URL provided by the Cloudfront. Don't forget to put "https://" before it
<img width="155" height="97" alt="image" src="https://github.com/user-attachments/assets/9b6ec222-2df7-427b-876e-54b3b2cf6b3d" />
